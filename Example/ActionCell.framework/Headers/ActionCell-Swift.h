...
@interface IconAction (SWIFT_EXTENSION(ActionCell))
- (void)setForeColorWithColor:(UIColor * _Nonnull)color;
- (void)setForeAlphaWithAlpha:(CGFloat)alpha;
@end
...
@interface TextAction (SWIFT_EXTENSION(ActionCell))
- (void)setForeColorWithColor:(UIColor * _Nonnull)color;
- (void)setForeAlphaWithAlpha:(CGFloat)alpha;
@end
